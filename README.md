...
Rice CS '28, focused on AI systems & applied ML.

**Now —** AI Software Engineering Intern on the Drive AI team at Drivetrain. Working on intelligent editing features for the platform's formula language: natural-language-to-formula, semantic validation, autocomplete, and contextual insights. Earlier this internship I designed and shipped an internal security-process automation system end-to-end in two weeks — config-driven, built on Linear + Slack + Git with no custom infrastructure.
